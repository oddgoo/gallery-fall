...
<div class="max-w-3xl mx-auto p-8">
    <h2 class="text-4xl mb-6 text-gray-800">Ground Floor</h2>
    <p class="text-lg leading-relaxed mb-6 text-gray-700">Welcome to the ground floor of the Gallery's Glitch.</p>
