...
<div class="max-w-3xl mx-auto p-8">
    ...
    <PuzzleContainer 
        title="Dazzling and Dismaying"
        puzzleId="b1_dazzling"
        let:puzzleId
    >
    ...
    <PuzzleContainer 
        title="They are all me"
        puzzleId="b1_broken_men"
        let:puzzleId
    >
